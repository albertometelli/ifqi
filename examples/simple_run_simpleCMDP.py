...
dir_path = "/Users/mirco/Desktop/Simulazioni/optSPMI_simpleCMDP"

mdp = SimpleCMDP(p=0, w=0)
...
plt.xlabel('Iteration')
plt.plot(iterations, opt_w_target[:, 0], color='tab:red', linestyle='dashed', label='target model')
