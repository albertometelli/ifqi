...
eps = 0.0
spmi = SPMI(mdp, eps, policy_chooser, model_chooser, max_iter=20000, use_target_trick=True, delta_q=1)
...
# plt.plot(iterations, opt_evaluations, linestyle='dashed', label='J spmi_opt')
# plt.legend(loc='best', fancybox=True)
# plt.savefig(dir_path + "/performance")
#
# plt.figure()
# plt.title('Alpha and Beta_i')
# plt.xlabel('Iteration')
# plt.plot(iterations, alfas, color='tab:blue', label='alfa spmi')
# plt.plot(iterations, betas, color='tab:red', label='beta spmi')
# plt.plot(iterations, opt_alfas, color='tab:blue', linestyle='dashed', label='alfa spmi_opt')
# plt.plot(iterations, opt_betas[:, 0], color='tab:red', linestyle='dashed', label='beta_0 spmi_opt')
# plt.plot(iterations, opt_betas[:, 1], color='tab:red', linestyle='dashed', label='beta_1 spmi_opt')
# plt.legend(loc='best', fancybox=True)
# plt.yscale('log')
# plt.savefig(dir_path + "/update coefficients")
#
# plt.figure()
# plt.title('Model coefficient')
# plt.xlabel('Iteration')
# plt.plot(iterations, coefficient, color='tab:blue', label='spmi')
# plt.plot(iterations, opt_coefficient, color='tab:red', label='spmi_opt')
# plt.legend(loc='best', fancybox=True)
# plt.savefig(dir_path + "/model coefficients")