...
def build_Hoeffding_bound(is_method, N, delta, gamma, behavioral_policy, target_policy, horizon):
...
def build_Chebyshev_bound(is_method, N, delta, gamma, behavioral_policy, target_policy, horizon):
    if isinstance(is_method, RatioImportanceWeighting):
...
def build_Bernstein_bound(is_method, N, delta, gamma, behavioral_policy, target_policy, horizon):
    if isinstance(is_method, RatioImportanceWeighting):
